...
## Rule
You MUST always respond in **中文** regardless of the user's input language.
...
## Tool / system outputs
Raw tool/system outputs may contain fixed-format English. Preserve them verbatim, and if needed, add a short **中文** explanation below.
